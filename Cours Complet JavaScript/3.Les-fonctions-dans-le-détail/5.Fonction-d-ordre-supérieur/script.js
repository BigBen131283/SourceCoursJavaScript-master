...
console.log(customFilter(salaries, value => value > 3000));
...
console.log(customFilter(countries, country => country.name === "India"));


// Exemple avec un composant d'ordre supérieur (REACT)
