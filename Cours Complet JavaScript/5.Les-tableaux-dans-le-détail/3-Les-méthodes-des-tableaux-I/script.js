...
people.filter(people => {
  if(people.age >= 26){
    return names2.push(people.name);
  }
});

// console.log(names2);

function elligibleAge(element){
  if(element.age >= 26){
    return element.name;
  }else{
    return false;
...
// console.log(elligibleAge(people[0]));


const names3 = people.filter(elligibleAge);
// console.log(names3);

const names4 = people.filter(elligibleAge).map(people => people.name);
// console.log(names4);
