...
console.log(cats.indexOf("Toto")); // -1
...
console.log(cats.includes("Lily")); // boolean
...
console.log(employees.some(employee => employee.age > 40));
...
console.log(weights.every(weight => weight > 40));
console.log(weights.every(weight => weight > 50));
