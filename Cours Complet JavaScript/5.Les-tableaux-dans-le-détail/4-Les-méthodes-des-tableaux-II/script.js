...
let moyenne = marks.reduce((acc, mark) => acc + mark) / marks.length
...
const letters = ["A","z","b", "B","a","d","e"];
letters.sort();
console.log(letters);

const numbers = [10,55,2,250,500,85]
numbers.sort((a,b) => a - b) // b - a pour l'ordre décroissant
console.log(numbers);
...
const words = ["Avion", "Bateau", "Train", "Zeppelin", "Aeronef", "Voiture"];
words.sort();
console.log(words);