...
function weatherFeeling(temp) {
  // if(temp <= 10) console.log("Il fait froid"); 
  // if(temp > 10 && temp <= 20) console.log("Il fait doux"); 
  // if(temp > 20) console.log("Il fait chaud"); 
...
function howGoodIsThatPlayer(player){
  // if(player.worldCup >= 1 && player.goldenBall >=2 && player.nationalCup >= 3) console.log(`${player.name}, Niveau exceptionnel`);
  // else if(player.goldenBall >= 1 && player.nationalCup >=1) console.log(`${player.name}, Bon niveau`);
  // else{
  //   console.log(`${player.name}, Niveau médiocre`);
  // }
  
  // Correction
  if(player.goldenBall >= 2 && player.worldCup >= 1 && player.nationalCup >= 3){
